...
from src.books.schemas import Book, BookUpdate, CreateBook, BookDetailModel
from src.db.main import get_session
from sqlmodel.ext.asyncio.session import AsyncSession
from src.books.service import BookService
from uuid import UUID
from src.auth.depenencies import AccessTokenBearer
from src.auth.depenencies import RoleChecker
...
async def update_book(book_uid: UUID,
...
async def delete_book(book_uid: UUID,
                       session:AsyncSession = Depends(get_session),
                        token_details:dict = Depends(access_token_bearer)):
